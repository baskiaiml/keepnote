...
public class LoggingAspect {
	 ...
	 * (@Before, @After, @AfterReturning, @AfterThrowing).
	 */
	@Before("execution(* com.stackroute.keepnote.controller.ReminderController.createReminder(..))")
	 ...
	 * @param joinPoint
	 */
	@After("execution(* com.stackroute.keepnote.controller.ReminderController.createReminder(..))")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.ReminderController.createReminder(..))", returning = "result")
	 ...
	 * @param error
	 */
	@AfterThrowing(pointcut = "execution(* com.stackroute.keepnote.controller.ReminderController.createReminder(..))", throwing = "error")
	 ...
	 * @param joinPoint
	 */
	@After("execution(* com.stackroute.keepnote.controller.ReminderController.delete*(..))")
	 ...
	 * @param error
	 */
	@AfterThrowing(pointcut = "execution(* com.stackroute.keepnote.controller.ReminderController.updateReminder(..))", throwing = "error")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.ReminderController.updateReminder(..))", returning = "result")
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* com.stackroute.keepnote.controller.ReminderController.get*(..))")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.ReminderController.get*(..))", returning = "result")
