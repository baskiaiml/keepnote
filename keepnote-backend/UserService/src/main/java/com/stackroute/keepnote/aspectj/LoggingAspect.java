...
public class LoggingAspect {
	 ...
	 */
	@Before("execution(* com.stackroute.keepnote.controller.UserController.registerUser(..))")
	 ...
	 * @param joinPoint
	 */
	@After("execution(* com.stackroute.keepnote.controller.UserController.registerUser(..))")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.UserController.registerUser(..))", returning = "result")
	 ...
	 * @param error
	 */
	@AfterThrowing(pointcut = "execution(* com.stackroute.keepnote.controller.UserController.registerUser(..))", throwing = "error")
	 ...
	 * @param joinPoint
	 */
	@After("execution(* com.stackroute.keepnote.controller.UserController.deleteUser(..))")
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* com.stackroute.keepnote.controller.UserController.getUserDetails(..))")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.UserController.getUserDetails(..))", returning = "result")
