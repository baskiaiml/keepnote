...
public class LoggingAspect {
	 ...
	 * @param joinPoint
	 */
	@After("execution(* com.stackroute.keepnote.controller.NoteController.delete*(..))")
	 ...
	 * @param error
	 */
	@AfterThrowing(pointcut = "execution(* com.stackroute.keepnote.controller.NoteController.updateNote(..))", throwing = "error")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.NoteController.updateNote(..))", returning = "result")
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* com.stackroute.keepnote.controller.NoteController.get*(..))")
	 ...
	 * @param result
	 */
	@AfterReturning(pointcut = "execution(* com.stackroute.keepnote.controller.NoteController.get*(..))", returning = "result")
