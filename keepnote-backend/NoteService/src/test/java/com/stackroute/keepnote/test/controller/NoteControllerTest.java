...
public class NoteControllerTest {
    ...
    public void getNoteByIdSuccess() throws Exception {
        ...
        when(noteService.getNoteByNoteId("Jhon123", new ObjectId().toString())).thenReturn(note);
    ...
    public void getNoteByIdFailure() throws Exception {
        ...
        when(noteService.getNoteByNoteId("Jhon123",new ObjectId().toString())).thenThrow(NoteNotFoundExeption.class);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/note/Jhon123/1")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isNotFound())
                .andDo(MockMvcResultHandlers.print());
