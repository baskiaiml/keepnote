...
public class CategoryRepositoryTest {
    ...
    public void createCategoryTest() {
        ...
        Category fetchedCategory = categoryRepository.findById(category.getCategoryId()).get();
        Assert.assertEquals("5b04f7411764e3765c35f8f6", fetchedCategory.getCategoryId());
    ...
    public void deleteCategorytest() {
        ...
        fetchedCategory = categoryRepository.findById(category.getCategoryId()).get();
    ...
    public void getAllCategoryByUserId() {
        ...
        category.setCategoryId("5b04f7411764e3765c35f8c4");
